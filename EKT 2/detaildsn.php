...
$id = $_GET['id'];
$dsn = query("SELECT * FROM daftar_dosen WHERE nid=$id");
  ...
  <div class="row mt-4">
    ...
    <div class="col-md-10 p-5 pt-5">
      ...
      <ul class="list-group">
        ...
        <li class="list-group-item">NIDN : <?= $dsn['nid']; ?></li>
        ...
        <li class="list-group-item">
          <a href="hapusdsn.php?id=<?= $dsn['nid']; ?>" onclick="return confirm('Apakah anda yakin akan menghapus data ini?');" class="btn btn-danger" role="button">Hapus</a> |
